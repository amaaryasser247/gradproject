            ...
            {activeTab === "billing" && (
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <button className="mt-2 border border-dashed border-[#C1714A]/30 bg-[#fffaf7] text-[#C1714A] font-semibold text-sm py-3 rounded-2xl hover:bg-orange-50 transition-colors">
                    + Add Payment Method
                  </button>
                </div>
              </div>
