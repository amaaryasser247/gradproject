...
<div className="grid md:grid-cols-3 gap-6 mt-8">
  ...
  {/* CARD 1 */}
  <div className="bg-linear-to-r from-[#d97757] to-[#e38b73] text-white p-8 rounded-2xl shadow-md hover:shadow-xl transition cursor-pointer">
  ...
  {/* CARD 2 */}
  <div className="bg-linear-to-r from-[#5e6b5f] to-[#6f8071] text-white p-8 rounded-2xl shadow-md hover:shadow-xl transition cursor-pointer">
  ...
  {/* CARD 3 */}
  <div className="bg-linear-to-r from-[#a78b7a] to-[#b59a89] text-white p-8 rounded-2xl shadow-md hover:shadow-xl transition cursor-pointer">
